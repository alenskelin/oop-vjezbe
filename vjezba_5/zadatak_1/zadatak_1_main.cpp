...
int main()
{
    ...
    coordinate_1.print_coordinates();
    coordinate_2.print_coordinates();

    coordinate_1.return_coordinates();
    coordinate_2.return_coordinates();

    coordinate_1.random_coordinate_generator(4, 10);
    coordinate_2.random_coordinate_generator(4, 10);

    coordinate_1.print_coordinates();
    coordinate_2.print_coordinates();

    coordinate_1.calculate_distance_between_two_coordinates_in_2d(coordinate_2);
    coordinate_1.calculate_distance_between_two_coordinates_in_3d(coordinate_2);
}